...
<div class="container-fluid">
  <div class="row">
   ...
   <hr>
    <div style="width:30%;height:300px;float:left;"><img src="a.jpg" width="420" height="300"></div>
    <div style="width:70%;height:300px;float:right;background-color:#26C6EE;font-size:20px">
        <h2>大甲鎮瀾宮</h2>
        <hr/>
        <p>大甲鎮瀾宮是位於台中市大甲區的一間媽祖廟，從清朝雍正年間建廟，民國69年改建。
            在台灣眾多廟宇中，具有一定的知名度，每年四月左右就會有大甲媽南下遶境的盛事，
            繞境隊伍跨越 台中市、彰化縣、雲林縣、嘉義縣四個縣市，吸引眾多信徒前往朝聖。</p>

        <p>交通</p>

        <p>火車: 大甲站下車後，步行約200公尺</p>
